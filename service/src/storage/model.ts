...
export const CHATMODELS: CHATMODEL[] = [
  ...
  'gpt-4-turbo', 'gpt-4-turbo-2024-04-09', 'dall-e-2', 'dall-e-3', 'gemini-pro', 'gemini-pro-vision', 'claude-2', 'claude-3-sonnet',
  ...
  'moonshot-v1-32k', 'moonshot-v1-128k', 'concise', 'detail', 'research',
]
