...
export const CHATMODELS: CHATMODEL[] = [
  ...
  'o1-mini', 'o1-mini-2024-09-12', 'dall-e-2', 'dall-e-3', 'gemini-pro', 'gemini-1.5-pro', 'gemini-1.5-pro-exp-0827', 'claude-2',
  'claude-3-sonnet', 'claude-3.5-sonnet', 'claude-3-opus', 'claude-3-haiku', 'glm-4-air', 'glm-4-airx', 'glm-4', 'glm-4-flash',
  'glm-4-0520', 'glm-4-plus', 'qwen-turbo', 'qwen-plus', 'qwen-max', 'yi-large', 'yi-medium', 'yi-medium-200k', 'yi-vl-plus',
  'yi-spark', 'yi-large-rag', 'yi-large-turbo', 'yi-lightning', 'yi-lightning-lite', 'SparkDesk-v3.5', 'SparkDesk-v4.0',
