...
'claude-3-opus' | 'claude-3-haiku' | 'gpt-3.5-turbo-online-with-gs' | 'gpt-4-online-with-gs' | 'gpt-4-1106-preview-online-with-gs'
...
export const CHATMODELS: CHATMODEL[] = [
  ...
  'claude-3-haiku', 'gpt-3.5-turbo-online-with-gs', 'gpt-4-online-with-gs', 'gpt-4-1106-preview-online-with-gs',
]
