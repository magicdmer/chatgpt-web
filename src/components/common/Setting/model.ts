...
'dall-e-3' | 'gemini-pro' | 'gemini-1.5-pro' | 'claude-2' | 'claude-3-sonnet' | 'claude-3-opus' | 'claude-3-haiku' |
'glm-3-turbo' | 'glm-4' | 'qwen-turbo' | 'qwen-plus' | 'qwen-max' | 'yi-34b-chat-0205' | 'yi-34b-chat-200k' | 'yi-vl-plus' |
