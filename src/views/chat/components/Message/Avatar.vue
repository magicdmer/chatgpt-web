...
<template>
  <template v-if="image">
    <NAvatar v-if="isString(avatar) && avatar.length > 0" :src="avatar" :fallback-src="defaultAvatar" :size="36" round />
    <NAvatar v-else round :src="defaultAvatar" :size="36" />
  </template>
  <span v-else class="ai-avatar-icon">
